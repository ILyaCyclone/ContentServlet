...
public interface DatabaseReader {
	...
	public void fetchDataFromResultSet(ResultSet resultSet, OutputStream osServlet, HttpServletResponse response,
			Cache persistantCache, String idInCache, Integer width, Integer height, int quality) throws SQLException, DatabaseReaderException, DatabaseReaderNoDataException, IOException;
}
